...
if __name__ == '__main__':
    ...
    generate_dataset_json(join(target_base, 'dataset.json'), target_imagesTr, target_imagesTs,
                          ('Darkfluid', 'T1_mprage', 'T1_mprageKM', 'T2'),
                          labels={0: 'background', 1: 'tumor'},
                          dataset_name=task_name, license='',
                          dataset_description="Gliomas segmentation for Tumour in on brain images using PETMRI_Glioma "
                                              "dataset",
                          dataset_reference="",
                          dataset_release='')
