...
if __name__ == '__main__':
    ...
    generate_dataset_json(join(target_base, 'dataset.json'), target_imagesTr, target_imagesTs,
                          ...
                          dataset_description="stroke segmentation on mcao_60, mcao_100 and human MRI images combined "
                                              "using patch method with 70:30 train test ratio.",
                          dataset_reference="-",
                          dataset_release='-')
