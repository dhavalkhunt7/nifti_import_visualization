...
create_folder(path + "/Task649_sampling_threshold_2")
#%%
create_folder(path + "/Task649_sampling_threshold_2/imagesTr")
create_folder(path + "/Task649_sampling_threshold_2/imagesTs")
create_folder(path + "/Task649_sampling_threshold_2/labelsTr")
create_folder(path + "/Task649_sampling_threshold_2/labelsTs")
...
for i in database.iterdir():
    ...
    save_files(nib.load(adc_file), path + "/Task649_sampling_threshold_2", new_name, counter, "adc")
    save_files(nib.load(t2_file), path + "/Task649_sampling_threshold_2", new_name, counter, "t2")
    save_files(nib.load(gt_file), path + "/Task649_sampling_threshold_2", new_name, counter, "mask")
