...
create_folder(path + "/Task707_sampling_threshold")

#%%
create_folder(path + "/Task707_sampling_threshold/imagesTr")
create_folder(path + "/Task707_sampling_threshold/imagesTs")
create_folder(path + "/Task707_sampling_threshold/labelsTr")
create_folder(path + "/Task707_sampling_threshold/labelsTs")
...
for i in database.glob("*"):
    ...
    if new_name in rat_list:
        ...
        save_files(nib.load(adc_file), path + "/Task707_sampling_threshold", new_name, flag_type, "adc")
        save_files(nib.load(t2_file), path + "/Task707_sampling_threshold", new_name, flag_type, "t2")
        save_files(nib.load(gt_file), path + "/Task707_sampling_threshold", new_name, flag_type, "mask")
