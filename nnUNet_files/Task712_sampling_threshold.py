...
create_folder(path + "/Task712_sampling_threshold")

#%%
create_folder(path + "/Task712_sampling_threshold/imagesTr")
create_folder(path + "/Task712_sampling_threshold/imagesTs")
create_folder(path + "/Task712_sampling_threshold/labelsTr")
create_folder(path + "/Task712_sampling_threshold/labelsTs")
