...
#%% task 1  for Task801
folder = "../nnUNet_raw_data_base/nnUNet_raw_data/Task801_control_training/"
...
for i in database.glob("*"):
    ...
    if count <= 16:
        ...
        save_files(nib.load(adc_file), path + "/Task801_control_training", new_name, flag_type, "adc")
        save_files(nib.load(t2_file), path + "/Task801_control_training", new_name, flag_type, "t2")
        save_files(nib.load(gt_file), path + "/Task801_control_training", new_name, flag_type, "mask")
